...
var $author$project$PhotoGroove$initialModel = {
	...
	sizes: _List_fromArray(
		[
			{selected: false, size: $author$project$PhotoGroove$Small},
			{selected: true, size: $author$project$PhotoGroove$Medium},
			{selected: false, size: $author$project$PhotoGroove$Large}
		]),
		...
		switch (msg.$) {
			...
			case 'ClickedSize':
				...
				var updateSizes = A2(
					$elm$core$List$map,
					function (s) {
						return _Utils_eq(s.size, size.size) ? size : {selected: false, size: s.size};
					},
					model.sizes);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{chosenSize: size.size, sizes: updateSizes}),
					$elm$core$Platform$Cmd$none);
			case 'GotRandomPhoto':
				var photo = msg.a;
				return _Utils_Tuple2(
...
var $author$project$PhotoGroove$printTuple = function (s) {
	return A2(
		$elm$html$Html$p,
		_List_Nil,
		_List_fromArray(
			[
				$elm$html$Html$text(
				$author$project$PhotoGroove$sizeToString(s.size)),
				$elm$html$Html$text(' -> '),
				$elm$html$Html$text(
				$elm$core$Debug$toString(s.selected))
			]));
};
var $author$project$PhotoGroove$sizeToClass = function (s) {
	return $author$project$PhotoGroove$sizeToString(s);
};
			...
			[
				...
				_List_fromArray(
					[
						...
						function (t) {
							return $author$project$PhotoGroove$ClickedSize(
								_Utils_update(
									size,
									{selected: t}));
						}),
						$elm$html$Html$Attributes$checked(size.selected)
					]),
				_List_Nil),
				$elm$html$Html$text(
...
var $author$project$PhotoGroove$viewLoaded = F4(
	function (photos, selectedUrl, chosenSize, sizes) {
		return _List_fromArray(
			[
				A2(
				$elm$html$Html$h1,
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$PhotoGroove$ClickedSurpireseMe)
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$id('choosen-size')
					]),
				A2($elm$core$List$map, $author$project$PhotoGroove$viewSizeChooser, sizes)),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
				...
				$elm$html$Html$div,
				_List_Nil,
				A2($elm$core$List$map, $author$project$PhotoGroove$printTuple, sizes)),
				A2(
				$elm$html$Html$img,
				_List_fromArray(
					[
		...
		function () {
			...
			switch (_v0.$) {
				case 'Loaded':
					...
					return A4($author$project$PhotoGroove$viewLoaded, photos, selectedUrl, model.chosenSize, model.sizes);
				case 'Loading':
					return _List_Nil;
				default:
